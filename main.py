...
try:
    ...
    phone_book = {
        "иванов иван иванович": {"mobilephone": ["79370757270"], "workphone": ["79370756666"], "birthday": ["13-08-1984"], "email": ["ivan_v@yandex.ru"]},
        "петров петр петрович": {"mobilephone": ["79161100000"] , "workphone": ["79161122222"], "birthday": ["01-01-1990"], "email": ["petr_p@yandex.ru"]}}
    save(phone_book)
